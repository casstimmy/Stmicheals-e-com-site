      ...
      <Center>
        <div className="min-h-screen px-4 py-8 sm:px-8 sm:py-10">
          <section className="theme-shell-light mx-auto max-w-3xl rounded-[2rem] p-6 text-center md:p-8">
            ...
            <h1 className="mt-4 text-3xl font-bold text-[var(--foreground-strong)] sm:text-4xl">Table request received</h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
              ...
              <Link href={getPublicSitePath(PUBLIC_SITE_KEYS.HOTEL, "/manage-bookings")} className="theme-button-accent inline-flex min-h-[3rem] items-center justify-center rounded-[1rem] px-5 py-3 text-sm font-semibold">
                Manage reservations
              </Link>
            </div>
          </section>
