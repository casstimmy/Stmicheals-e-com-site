...
export const PUBLIC_SITE_CONFIGS = {
  [PUBLIC_SITE_KEYS.STORE]: {
    ...
    heroDescription:
      "Browse groceries, pantry staples, beverages, and everyday essentials through a calmer storefront built around stock visibility, repeat purchasing, and dependable checkout.",
    heroHighlights: [
    ...
    serviceHighlights: [
      "OTP-based customer access",
      "Server-validated payment flow",
      "Stock-aware ordering with live shipping quotes",
    ],
    showCart: true,
