...
export const PUBLIC_SITE_CONFIGS = {
  [PUBLIC_SITE_KEYS.STORE]: {
    ...
    tagLine: "Warehouse-direct essentials",
    topBarCopy: "Warehouse-direct ordering for groceries, drinks, and repeat household supply",
    topBarCta: "Shop current stock",
    topBarCtaHref: "/products",
    heroEyebrow: "Warehouse-direct supply",
    heroTitle: "Clear stock. Fair pricing. Faster ordering for home and business.",
    heroDescription:
      "Browse groceries, pantry staples, beverages, and everyday essentials in a calmer storefront built around stock visibility and reliable checkout.",
    heroHighlights: [
      "Stock-verified checkout",
      "Delivery-aware pricing",
    ],
    featuredProductLabel: "Warehouse pick",
    secondaryCtaLabel: "Browse Categories",
    listingEyebrow: "Warehouse catalog",
    listingTitle: "Store Products",
    listingDescription:
      "Filter warehouse products by category, search by keyword, and move through the catalog with URL-backed filters and clearer product signals.",
    categoryEyebrow: "Shop by aisle",
    categoryTitle: "Shop Store Categories",
    categoryDescription:
      "Browse warehouse categories, narrow results with live search, and jump straight into the relevant catalog slice.",
    ...
    serviceHighlights: [
      ...
      "Clear store contact details",
      "Policy and delivery links",
    ],
    showCart: true,
...
export function getPublicSiteLocationTokens(siteKey) {
  return [...(SITE_LOCATION_TOKENS[normalizePublicSite(siteKey)] || [])];
}
